...
import com.szabh.androidblesdk3.MyNotificationListenerService
        ...
        listView.apply {
            ...
            setOnItemClickListener { _, _, position, _ ->
                when {
                    ...
                    bleKeys[position] == BleKey.FACTORY_TEST -> {
                        val intent = Intent(mContext, FactoryTestActivity::class.java)
                        startActivity(intent)
                    }
                    else -> {
