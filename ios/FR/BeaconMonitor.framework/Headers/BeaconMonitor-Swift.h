...
#ifndef BEACONMONITOR_SWIFT_H
#define BEACONMONITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BeaconMonitor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13BeaconMonitor13BeaconMonitor")
...
@interface BeaconMonitor (SWIFT_EXTENSION(BeaconMonitor)) <CLLocationManagerDelegate>
...
SWIFT_PROTOCOL("_TtP13BeaconMonitor21BeaconMonitorDelegate_")
@protocol BeaconMonitorDelegate
@optional
/// Will be called every time the CLLocationManager receives CLBeacons.
- (void)receivedAllBeacons:(BeaconMonitor * _Nonnull)monitor beacons:(NSArray<CLBeacon *> * _Nonnull)beacons;
/// Will be called every time the CLLOcationManager receives CLBeacons, that matches to a set list of Beacons.
- (void)receivedMatchingBeacons:(BeaconMonitor * _Nonnull)monitor beacons:(NSArray<CLBeacon *> * _Nonnull)beacons;
...
SWIFT_CLASS("_TtC13BeaconMonitor12BeaconSender")
@interface BeaconSender : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CBPeripheralManager;

@interface BeaconSender (SWIFT_EXTENSION(BeaconMonitor)) <CBPeripheralManagerDelegate>
