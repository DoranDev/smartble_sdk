...
//
//NSString *const FotaASIS3StorageClassStandard = @"STANDARD";
//NSString *const FotaASIS3StorageClassReducedRedundancy = @"REDUCED_REDUNDANCY";
//
//@implementation FotaASIS3ObjectRequest
//
//- (FotaASIHTTPRequest *)HEADRequest
//{
//	FotaASIS3ObjectRequest *headRequest = (FotaASIS3ObjectRequest *)[super HEADRequest];
...
//{
//	FotaASIS3ObjectRequest *newRequest = [[[self alloc] initWithURL:nil] autorelease];
...
//{
//	FotaASIS3ObjectRequest *newRequest = [self requestWithBucket:theBucket key:theKey];
...
//	[newRequest setRequestMethod:@"PUT"];
//	[newRequest setMimeType:[FotaASIHTTPRequest mimeTypeForFileAtPath:filePath]];
//	return newRequest;
//}
//
...
//{
//	FotaASIS3ObjectRequest *newRequest = [super copyWithZone:zone];
...
//{
//	if ([self subResource]) {
//		[self setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@://%@.%@%@?%@",[self requestScheme],[self bucket],[[self class] S3Host],[FotaASIS3Request stringByURLEncodingForS3Path:[self key]],[self subResource]]]];
//	} else {
//		[self setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@://%@.%@%@",[self requestScheme],[self bucket],[[self class] S3Host],[FotaASIS3Request stringByURLEncodingForS3Path:[self key]]]]];
//	}
//}
//
//- (NSString *)mimeType
...
//		return [FotaASIHTTPRequest mimeTypeForFileAtPath:[self postBodyFilePath]];
//	} else {
...
//		return [NSString stringWithFormat:@"/%@%@?%@",[self bucket],[FotaASIS3Request stringByURLEncodingForS3Path:[self key]], [self subResource]];
//	}
//	return [NSString stringWithFormat:@"/%@%@",[self bucket],[FotaASIS3Request stringByURLEncodingForS3Path:[self key]]];
//}
//
...
//	if ([self sourceKey]) {
//		NSString *path = [FotaASIS3Request stringByURLEncodingForS3Path:[self sourceKey]];
