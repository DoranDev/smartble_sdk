...
////
//
//#import "FotaASIS3ServiceRequest.h"
//#import "FotaASIS3Bucket.h"
//
//// Private stuff
//@interface FotaASIS3ServiceRequest ()
//@property (retain) NSMutableArray *buckets;
//@property (retain, nonatomic) FotaASIS3Bucket *currentBucket;
//@property (retain, nonatomic) NSString *ownerID;
//@property (retain, nonatomic) NSString *ownerName;
//@end
//
//@implementation FotaASIS3ServiceRequest
//
//+ (id)serviceRequest
//{
//	FotaASIS3ServiceRequest *request = [[[self alloc] initWithURL:nil] autorelease];
//	return request;
//}
//
...
//		[self setCurrentBucket:[FotaASIS3Bucket bucketWithOwnerID:[self ownerID] ownerName:[self ownerName]]];
//	}
...
//		[[self currentBucket] setCreationDate:[[FotaASIS3Request S3ResponseDateFormatter] dateFromString:[self currentXMLElementContent]]];
