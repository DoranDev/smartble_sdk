...
////
//
//#import "FotaASIS3Request.h"
//#import <CommonCrypto/CommonHMAC.h>
//
//NSString *const FotaASIS3AccessPolicyPrivate = @"private";
//NSString *const FotaASIS3AccessPolicyPublicRead = @"public-read";
//NSString *const FotaASIS3AccessPolicyPublicReadWrite = @"public-read-write";
//NSString *const FotaASIS3AccessPolicyAuthenticatedRead = @"authenticated-read";
//NSString *const FotaASIS3AccessPolicyBucketOwnerRead = @"bucket-owner-read";
//NSString *const FotaASIS3AccessPolicyBucketOwnerFullControl = @"bucket-owner-full-control";
//
//NSString *const FotaASIS3RequestSchemeHTTP = @"http";
//NSString *const FotaASIS3RequestSchemeHTTPS = @"https";
//
//static NSString *sharedAccessKey = nil;
//static NSString *sharedSecretAccessKey = nil;
//
//// Private stuff
//@interface FotaASIS3Request ()
//	+ (NSData *)HMACSHA1withKey:(NSString *)key forString:(NSString *)string;
//@end
//
//@implementation FotaASIS3Request
//
...
//	[self setRequestScheme:FotaASIS3RequestSchemeHTTP];
//	return self;
//}
//
//
...
//{
//	[self setDateString:[[FotaASIS3Request S3RequestDateFormatter] stringFromDate:date]];	
//}
//
//- (FotaASIHTTPRequest *)HEADRequest
//{
//	FotaASIS3Request *headRequest = (FotaASIS3Request *)[super HEADRequest];
...
//	if (![self accessKey]) {
//		[self setAccessKey:[FotaASIS3Request sharedAccessKey]];
//	}
//	if (![self secretAccessKey]) {
//		[self setSecretAccessKey:[FotaASIS3Request sharedSecretAccessKey]];
//	}
...
//	NSString *signature = [FotaASIHTTPRequest base64forData:[FotaASIS3Request HMACSHA1withKey:[self secretAccessKey] forString:stringToSign]];
...
//{
//	[self failWithError:[NSError errorWithDomain:FotaNetworkRequestErrorDomain code:ASIS3ResponseParsingFailedType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:@"Parsing the resposnse failed",NSLocalizedDescriptionKey,parseError,NSUnderlyingErrorKey,nil]]];
//}
//
...
//		[self failWithError:[NSError errorWithDomain:FotaNetworkRequestErrorDomain code:ASIS3ResponseErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[self currentXMLElementContent],NSLocalizedDescriptionKey,nil]]];
...
//{
//	FotaASIS3Request *newRequest = [super copyWithZone:zone];
