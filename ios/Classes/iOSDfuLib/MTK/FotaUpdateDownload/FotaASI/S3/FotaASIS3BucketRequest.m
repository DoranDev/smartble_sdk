...
////
//
//#import "FotaASIS3BucketRequest.h"
//#import "FotaASIS3BucketObject.h"
//
//
//// Private stuff
//@interface FotaASIS3BucketRequest ()
//@property (retain, nonatomic) FotaASIS3BucketObject *currentObject;
//@property (retain) NSMutableArray *objects;
//@property (retain) NSMutableArray *commonPrefixes;
//@property (assign) BOOL isTruncated;
//@end
//
//@implementation FotaASIS3BucketRequest
//
...
//{
//	FotaASIS3BucketRequest *request = [[[self alloc] initWithURL:nil] autorelease];
...
//{
//	FotaASIS3BucketRequest *request = [self requestWithBucket:theBucket];
...
//		[self setCurrentObject:[FotaASIS3BucketObject objectWithBucket:[self bucket]]];
//	}
...
//		[[self currentObject] setLastModified:[[FotaASIS3Request S3ResponseDateFormatter] dateFromString:[self currentXMLElementContent]]];
...
//{
//	FotaASIS3BucketRequest *newRequest = [super copyWithZone:zone];
