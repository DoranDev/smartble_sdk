...
static FotaRequestType sma_requestType = FotaRequestTypeJSON;
static FotaResponseType sma_responseType = FotaResponseTypeJSON;

@implementation FotaAFNetRequestManager

+ (void)FotaconfigRequestType:(FotaRequestType)FotarequestType {
    sma_requestType = FotarequestType;
}

+ (void)FotaconfigResponseType:(FotaResponseType)FotaresponseType {
    sma_responseType = FotaresponseType;
}
...
+ (AFHTTPSessionManager *)SMAmanager{
    ...
    switch (sma_requestType) {
        case FotaRequestTypeJSON: {
            manager.requestSerializer = [AFJSONRequestSerializer serializer];
            [manager.requestSerializer setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
            break;
        }
        case FotaRequestTypePlainText: {
    ...
    switch (sma_responseType) {
        ...
        case FotaResponseTypeXML: {
            manager.responseSerializer = [AFXMLParserResponseSerializer serializer];
            break;
        }
        case FotaResponseTypeData: {
    ...
    sma_requestType = FotaRequestTypeJSON;
    sma_responseType = FotaResponseTypeJSON;
    return manager;
}
