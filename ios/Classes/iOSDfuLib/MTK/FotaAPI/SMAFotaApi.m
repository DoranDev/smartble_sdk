...
//            if (self.fotaDelegate && [self.fotaDelegate respondsToSelector:@selector(registerDeviceSuccess:)]) {
//                [self.fotaDelegate registerDeviceSuccess:data];
//            }
//        }else {
//            if (self.fotaDelegate && [self.fotaDelegate respondsToSelector:@selector(registerDeviceFail:)]) {
//                [self.fotaDelegate registerDeviceFail:responseObject];
//            }
////            [self.fotaDelegate registerDeviceFail:responseObject];
//        }
//    } fail:^(NSError *error) {
//        if (self.fotaDelegate && [self.fotaDelegate respondsToSelector:@selector(netWorkingFailure)]) {
...
////                    switch (networkType) {
////                        case 0://无服务
////                            network = [NSString stringWithFormat:@"%@-%@", isCardOne ? @"Card 1" : @"Card 2", @"无服务"];
////                            break;
////                        case 3:
////                            network = [NSString stringWithFormat:@"%@-%@", isCardOne ? @"Card 1" : @"Card 2", @"2G"];
////                            break;
////                        case 4:
