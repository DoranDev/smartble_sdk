...
data class BleLocationGga(
    ...
    override fun toString(): String {
        return "BleLocationGga(mTime=$mTime, mLatitude=$mLatitude, mLongitude=$mLongitude, positioningQuality=$positioningQuality, satelliteCount=$satelliteCount, mHorizontalDilutionPrecision=$mHorizontalDilutionPrecision, altitude=$altitude)"
    }
